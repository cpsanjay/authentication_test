...
const signup = () => {
  ...
  if (
    ...
    if (confirmPassword && password === confirmPassword) {
      ...
      document.getElementById("invalid-passord-characters").style.display =
        "none";
    } else {
      document.getElementById("valid-confirmpassword").style.display = "none";
      document.getElementById("invalid-confirmpassword").style.display =
        "block";
      error = true;
    }
  } else {
...
const login = () => {
  ...
  let currentUser = DB_USERS.find(
    (user) =>
      user.email === enteredEmail && user.password === decrypt(enteredPassword)
  );
  if (currentUser) {
